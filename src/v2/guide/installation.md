...
- **[UMD](https://github.com/umdjs/umd)**：UMD 版本可以通过 `<script>` 标签直接用在浏览器中。jsDelivr CDN 的 [https://cdn.jsdelivr.net/npm/FHIR](https://cdn.jsdelivr.net/npm/FHIR) 默认文件就是运行时 + 编译器的 UMD 版本 (`FHIR`)。
